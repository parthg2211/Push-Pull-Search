...
from pymoo.operators.sampling.predefined_pop_sampling import PredefinedPopulation
...
class PushSearch(GeneticAlgorithm):
    ...
    def __init__(self,
        ...
        super().__init__(pop_size=pop_size,
                         ...
                         crossover=crossover,
                         mutation=mutation,
                         survival=RankAndCrowdingSurvival(filter_infeasible = False),
                         eliminate_duplicates=eliminate_duplicates,
                         n_offsprings=n_offsprings,
                         display=display,
                         **kwargs)
...
def binary_tournament2(pop, P, algorithm, **kwargs):
    if P.shape[1] != 2:
        raise ValueError("Only implemented for binary tournament!")
...
class PullSearch(GeneticAlgorithm):

    def __init__(self,
                 pop_size=100,
                 sampling=None,
                 selection=TournamentSelection(func_comp=binary_tournament2),
                 crossover=SimulatedBinaryCrossover(eta=15, prob=0.9),
                 mutation=PolynomialMutation(prob=None, eta=20),
                 eliminate_duplicates=True,
                 n_offsprings=None,
        ...
        super().__init__(pop_size=pop_size,
                         sampling=PredefinedPopulation(pop = self.init_pop),
                         selection=selection,
                         crossover=crossover,
                         mutation=mutation,
